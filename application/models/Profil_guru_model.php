...
class Profil_guru_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id_guru,nama_guru,email,mapel,kelas_ajar,jabatan,image');
        $this->datatables->from('profil_guru');
        //add this line for join
        //$this->datatables->join('table2', 'profil_guru.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('profilguru/read/$1'),'<i class="fa fa-eye" aria-hidden="true"></i>', array('class' => 'btn btn-danger btn-sm'))." 
            ".anchor(site_url('profilguru/update/$1'),'<i class="fa fa-pencil-square-o" aria-hidden="true"></i>', array('class' => 'btn btn-danger btn-sm'))." 
    ...
    function get_gambar($id){
        ...
        return $this->db->get('profil_guru')->result();
    }
