...
class Fasilitas_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id_fasilitas,nama_fasilitas');
        $this->datatables->from('fasilitas');
        //add this line for join
        //$this->datatables->join('table2', 'fasilitas.field = table2.field');
        $this->datatables->add_column('action',anchor(site_url('fasilitas/update/$1'),'<i class="fa fa-pencil-square-o" aria-hidden="true"></i>', array('class' => 'btn btn-danger btn-sm'))." 
...
/* Generated by Harviacode Codeigniter CRUD Generator 2018-09-14 14:28:09 */
/* http://harviacode.com */