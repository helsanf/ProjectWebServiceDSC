    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA PROFIL GURU</h3>
            </div>
...
<table class='table table-bordered>'        
	    ...
	    <tr><td width='200'>Kelas Ajar <?php echo form_error('kelas_ajar') ?></td><td>
		<?php echo form_dropdown('kelas_ajar',array('X'=>'X','XI'=>'XI','XII'=>'XII'),$kelas_ajar,array('class'=>'form-control'));?>
		<!-- <input type="text" class="form-control" name="kelas_ajar" id="kelas_ajar" placeholder="Kelas Ajar" value="<?php echo $kelas_ajar; ?>" />--></td></tr> 
	    <tr><td width='200'>Jabatan <?php echo form_error('jabatan') ?></td><td><input type="text" class="form-control" name="jabatan" id="jabatan" placeholder="Jabatan" value="<?php echo $jabatan; ?>" /></td></tr>
	     <tr><td width='200'>Foto Profile <?php echo form_error('image') ?></td><td> <input type="file" name="image"></td></tr>
